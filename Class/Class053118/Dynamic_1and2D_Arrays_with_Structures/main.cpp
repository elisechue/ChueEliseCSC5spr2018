/* 
 * File:   main.cpp
 * Author: Dr Mark E. Lehr, Elise Chue
 * Created on May 31, 2018, 10:35 AM
 * Purpose:  Dynamic 1 and 2 D Arrays with STRUCTURES
 */
...
int main(int argc, char** argv) {
    ...
    //Clean up
    delete []array->data;   //data within the structure is the array
...
Array1D *fillAry(int n){
    //Allocate memory
    Array1D *a=new Array1D;     //cant just point to it gotta allocate memory
    a->size=n;
...
//remember to debug one step/section at a time. oftentimes the error is not gonna be informative
//difference between dot and arrow. dot is for regular variables. arrow is for pointers