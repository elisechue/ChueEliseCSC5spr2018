...
//Function Prototypes 
void retirem(int,float,float, int [],float [],float [],float []);
void dsplay(int,float, int [],float [],float [],float []);
...
void dsplay(int nYears, float savReq, int year[],float svBegYr[],
...
void retirem(int nYears, float savReq, float roi, int year[],float svBegYr[],
             float dpEndYr[],float inEndYr[]){
